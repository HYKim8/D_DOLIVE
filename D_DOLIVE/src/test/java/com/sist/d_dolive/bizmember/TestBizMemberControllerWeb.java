...
public class TestBizMemberControllerWeb {
	...
	public void setUp() {
		...
		bizMemberList = Arrays.asList(
				new BizMemberVO("이메일123", "비밀번호1", "1", "박종훈1", "920826", "서울시 노원구", "안알랴줌동", "12345", "010-0000-0000", "123-45-67891", "010-1111-1111", "PCODE_12345", "pname1", "paddr1", "admin01", "2020/05/11", "admin01", "2020/05/11")
				, new BizMemberVO("이메일2", "비밀번호2", "2", "박종훈2", "920826", "서울시 노원구", "안알랴줌동", "12345", "010-0000-0000", "123-45-67891", "010-1111-1111", "PCODE_12345", "pname2", "paddr2", "admin01", "2020/05/11", "admin01", "2020/05/11")
				, new BizMemberVO("이메일3", "비밀번호3", "1", "박종훈3", "920826", "서울시 노원구", "안알랴줌동", "12345", "010-0000-0000", "123-45-67891", "010-1111-1111", "PCODE_12345", "pname3", "paddr3", "admin01", "2020/05/11", "admin01", "2020/05/11")
		);
